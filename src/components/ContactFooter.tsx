...
const links = [
  {
    ...
    colorClass:
      "group-hover:text-blue-600 group-hover:drop-shadow-[0_0_10px_rgba(37,99,235,0.7)]",
  },
  {
    icon: Github,
    label: "GitHub",
  ...
  },
  {
    ...
    colorClass:
      "group-hover:text-green-500 group-hover:drop-shadow-[0_0_10px_rgba(34,197,94,0.7)]",
  },
  {
    icon: Mail,
    label: "Email",
    ...
    colorClass:
      "group-hover:text-red-500 group-hover:drop-shadow-[0_0_10px_rgba(239,68,68,0.7)]",
  },
];
  ...
  <LazyMotion features={domAnimation}>
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <m.div
          className="grid grid-cols-2 gap-6 justify-items-center md:flex md:justify-center"
        ...
        >
          {links.map((link) => (
            ...
            >
              <link.icon
                className={cn(
                  "w-7 h-7 text-muted-foreground transition-all duration-300",
                  link.colorClass,
                )}
              />
